...
<div class="contenido">
  ...
  <section class="calendario clearfix">
    ...
    <div class="calevent" id="cal4"></div>
    <div class="calevent" id="cal5"></div>
    <div class="calevent" id="cal6"></div>
    ...
    <div class="calevent" id="cal7"></div>
    <div class="calevent" id="cal8"></div>
    <div class="calevent" id="cal9"></div>
    ...
    <div class="calevent" id="cal10"></div>
    <div class="calevent" id="cal11"></div>
    <div class="calevent" id="cal12"></div>
    ...
    <div class="calevent" id="cal13"></div>
    <div class="calevent" id="cal14"></div>
    <div class="calevent" id="cal15"></div>
    ...
    <div class="calevent" id="cal16"></div>
    <div class="calevent" id="cal17"></div>
  </section>
</div>
<?php get_footer(); ?>